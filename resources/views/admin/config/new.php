              ...
              <form id="quickForm" method="post" action="/admin/page/add" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="title" value="<?= set_value('title') ?>" class="form-control" id="" placeholder="" required="">
                  </div>
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="title_seo" value="<?= set_value('title_seo') ?>" class="form-control" id="" placeholder="">
                  </div>
